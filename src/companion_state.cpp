...
static const FaceSpec FACE_SPECS[] = {
  ...
  {FaceId::SunnyIdle, "sunny", "Sunny idle"},
  {FaceId::RainyIdle, "rainy", "Rainy idle"},
  {FaceId::CloudyIdle, "cloudy", "Cloudy idle"},
  {FaceId::StormyIdle, "stormy", "Stormy idle"},
  {FaceId::FoggyIdle, "foggy", "Foggy idle"},
  {FaceId::WindyIdle, "windy", "Windy idle"},
  {FaceId::HotIdle, "hot", "Hot day idle"},
  {FaceId::ColdIdle, "cold", "Cold day idle"},
  {FaceId::MorningIdle, "morning", "Morning idle"},
  {FaceId::AfternoonIdle, "afternoon", "Afternoon idle"},
  {FaceId::EveningIdle, "evening", "Evening idle"},
  {FaceId::NightIdle, "night", "Night idle"},
  {FaceId::NewMoonIdle, "new-moon", "New moon idle"},
  {FaceId::CrescentMoonIdle, "crescent-moon", "Crescent moon idle"},
  {FaceId::HalfMoonIdle, "half-moon", "Half moon idle"},
  {FaceId::FullMoonIdle, "full-moon", "Full moon idle"},
  {FaceId::SpringIdle, "spring", "Spring idle"},
  {FaceId::SummerIdle, "summer", "Summer idle"},
  {FaceId::MonsoonIdle, "monsoon", "Monsoon idle"},
  {FaceId::AutumnIdle, "autumn", "Autumn idle"},
  {FaceId::WinterIdle, "winter", "Winter idle"},
